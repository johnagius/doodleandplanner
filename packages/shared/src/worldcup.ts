...
export const WC_SEED_VERSION = 6;
...
// Round-of-32 template — the official FIFA World Cup 2026 bracket, ordered so it
// reads top-to-bottom in kick-off order: the 28 June opener (M73, South Africa v
// Canada's slot, 2A v 2B) sits at the very top, and each subsequent tie follows
// when it's played, while every tie still sits next to the partner it advances
// with. The plain "consecutive pairs advance" fold below then reproduces the real
// bracket with no crossing lines: ties 1&2 feed R16-1, 3&4 feed R16-2, and so on
// to the final. Each tie's real kick-off and venue live in WC_KNOCKOUT_SCHEDULE,
// keyed by the r32-N id.
//
...
const R32_TEMPLATE: Array<[string, string]> = [
  ['R:A', 'R:B'], // M73 — r32-1  (the 28 June opener, top of the bracket)
  ['W:F', 'R:C'], // M75 — r32-2
  ['W:E', 'T:0'], // M74 — r32-3
  ['W:I', 'T:1'], // M77 — r32-4
  ['W:G', 'T:3'], // M82 — r32-5
